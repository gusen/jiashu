<?php
return array(
	'appName' => 'JiashuPHP_default',//your web app name.你的程序名称
	...
	'database' => array(//database config,you can set multiple records,So you can connect a number of different databases in your application.  e.g. the first is a MySql database, and the second is an Oracle database.设置数据库连接信息,可以输入多个,这样你可以在你的应用中连接多个不同的数据库,如第一个是MySql数据库,第二个是Oracle数据库
		'm1' => array(//database config name,you can set any string, but it is unique.数据库连接名称,随便起名,只要不和其他的数据库配置名重复即可
			'type' => 'mysql',//database type,only support mysql database now.数据库类型,现在支持MySql数据库
			...
			'database' => 'test',//database name.数据库名
			'tablePrefix' => 'gs_',//table prefix string.表前缀
			'sqldebug' => true,
		),
		'm2' => array(
			'type' => 'mysql',
